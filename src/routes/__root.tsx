...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Entertainme — The Pulse of Pop Culture" },
      { name: "description", content: "Celebrity news, TV, music, style, royals and sport. Breaking entertainment stories, updated all day on Entertainme." },
      { property: "og:title", content: "Entertainme — The Pulse of Pop Culture" },
      { property: "og:description", content: "Celebrity news, TV, music, style, royals and sport. Breaking entertainment stories, updated all day on Entertainme." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Entertainme" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#000000" },
      { name: "twitter:title", content: "Entertainme — The Pulse of Pop Culture" },
      { name: "twitter:description", content: "Celebrity news, TV, music, style, royals and sport. Breaking entertainment stories, updated all day on Entertainme." },
